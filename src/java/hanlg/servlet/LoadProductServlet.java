...
public class LoadProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("LoadProductServlet[SQLException]=" + ex.getMessage());
        } catch (NamingException ex) {
             log("LoadProductServlet[NamingException]=" + ex.getMessage());
            
        } catch (ClassNotFoundException ex) {
            log("LoadProductServlet[ClassNotFoundException]=" + ex.getMessage());
        } finally {
