 ...
 * @author DELL
 */
public class DeleteProductoutofCartServlet extends HttpServlet {
        ...
        try {
            ...
            if (session != null) {
                ...
                if (cart != null) {
                    ...
                    if (items != null) {
                        //4. Cust takes all selected remove items
                      String item = request.getParameter("productremove");
                            if (item != null) {
                                    cart.RemoveItemFromCart(item);                                                              
                                    session.setAttribute("CUSTCART", cart);
                        }//end if having selected items
                    }//end if carts are existed
