    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           //request.setAttribute("txtSearch", null);
            ...
            log("SearchProductServlet[SQLException]=" + ex.getMessage());
        } catch (NamingException ex) {
             log("SearchProductServlet[NamingException]=" + ex.getMessage());
            
        } catch (ClassNotFoundException ex) {
            log("SearchProductServlet[ClassNotFoundException]=" + ex.getMessage());
        } finally {
